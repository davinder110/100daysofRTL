...
HD_PWD='G:/FPGA/MIRROR_DISPLAY/MIRROR_DISPLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mirror_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mirror_Display.tcl
